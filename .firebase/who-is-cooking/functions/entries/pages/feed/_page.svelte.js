...
const Card = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	let { createdAt } = $$props;
	let { link } = $$props;
	if ($$props.dish === void 0 && $$bindings.dish && dish !== void 0) $$bindings.dish(dish);
	if ($$props.chef === void 0 && $$bindings.chef && chef !== void 0) $$bindings.chef(chef);
	if ($$props.photoURL === void 0 && $$bindings.photoURL && photoURL !== void 0)
		$$bindings.photoURL(photoURL);
	if ($$props.cost === void 0 && $$bindings.cost && cost !== void 0) $$bindings.cost(cost);
